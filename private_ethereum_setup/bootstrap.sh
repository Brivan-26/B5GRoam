...
gnome-terminal --title="Node 1" -- bash -c "geth --datadir node1 --port 30306 --bootnodes '$BOOTNODE' --networkid 12345 --allow-insecure-unlock --unlock 0x73a7245EFcAeb3Addf55a55afFc75A956b69854c --password node1/password.txt --ws --ws.addr="0.0.0.0" --ws.api="personal,eth,net,web3,txpool,miner" --ws.port="9000" --http --http.addr '0.0.0.0' --http.port 8545 --http.api 'eth,net,web3,txpool,personal,miner' --http.corsdomain '*' --miner.etherbase 0x73a7245EFcAeb3Addf55a55afFc75A956b69854c --mine --syncmode full --miner.gaslimit 1000000000 --rpc.gascap 1000000000; exec bash"
